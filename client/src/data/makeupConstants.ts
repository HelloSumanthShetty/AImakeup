...
import { Sparkles, Eye, Facebook, Smile, Scissors, User } from 'lucide-react';
...
export interface MakeupOption {
    id: string;
    label?: string;
    value: string; // Hex color or asset URL
                ...
                features: [
                    {
                        ...
                        options: [
                            ...
                            { id: 'length', value: 'length', label: 'Lengthening' }
                        ]
                    }
                ]
            },
        ...
        subCategories: [
            {
                ...
                features: [
                    ...
                    },
                    {
                        ...
                        region: 'lips',
                        options: [
                            { id: 'matte', value: 'matte', label: 'Matte', render: { opacity: 0.9, blendMode: 'multiply' } },
                            { id: 'satin', value: 'satin', label: 'Satin', render: { opacity: 0.7, blendMode: 'soft-light' } },
                            { id: 'gloss', value: 'gloss', label: 'High Gloss', render: { opacity: 0.6, blendMode: 'overlay' } }
                        ]
                    }
                ]
            },
